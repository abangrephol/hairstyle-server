    ...
    <div class="row">
      ...
      <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                   <div class="main">
                    <div class="col-sm-12">
            <form action="{{url('/frames/update/'.$frames->frame_id)}}" method="post" enctype="multipart/form-data">
            ...
            <div class="col-sm-12">
                                                   <div class="cntct_dtls" style=" margin-top:2%;">
                                                     <div class="rg_bor" style="border-right:none;">
                                                       <ul>
                                                         <li>
                                                           <div class="lbl_lfts">Frame Image</div>
                                                           <div class="lbl_rgts"><div class="col-sm-12">
                                                            ...
                                                            <div class="lbl_rgts"><div class="col-sm-12">
                                                                <input type="text" name="name" value="{{$frames->name}}"/>
                                                            </div>
                                                            </div>
                                                          </li>
                                                          <li>
                                                          ...
                                                          <div class="lbl_rgts"><div class="col-sm-12">
                                                                <input type="text" name="description" value="{{$frames->description}}"/>
                                                          </div>
                                                          </div>
                                                          </li>
                                                         </ul>
