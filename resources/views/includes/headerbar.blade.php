<div class="headerbar">
  ...
  <form hidden class="searchform" action="http://prototype-crm.embedinfosoft.com/index.html" method="post">
        ...
        <div style="display: none;" class="btn-group">
          ...
          <div  class="dropdown-menu dropdown-menu-head pull-right">
            ...
            <ul class="dropdown-list user-list">
              <li class="new">
                <div class="thumb"><a href="#"><img src="{{url('/images/photos/user1.png')}}" alt="" /></a></div>
                <div class="desc">
                  <h5><a href="#">Draniem Daamul (@draniem)</a> <span class="badge badge-success">new</span></h5>
                </div>
              </li>
              <li class="new">
                <div class="thumb"><a href="#"><img src="{{url('/images/photos/user2.png')}}" alt="" /></a></div>
                <div class="desc">
                  <h5><a href="#">Zaham Sindilmaca (@zaham)</a> <span class="badge badge-success">new</span></h5>
                </div>
              </li>
              <li>
                <div class="thumb"><a href="#"><img src="{{url('/images/photos/user3.png')}}" alt="" /></a></div>
                <div class="desc">
                  <h5><a href="#">Weno Carasbong (@wenocar)</a></h5>
                </div>
              </li>
              <li>
                <div class="thumb"><a href="#"><img src="{{url('/images/photos/user4.png')}}" alt="" /></a></div>
                <div class="desc">
                  <h5><a href="#">Nusja Nawancali (@nusja)</a></h5>
                </div>
              </li>
              <li>
                <div class="thumb"><a href="#"><img src="{{url('/images/photos/user5.png')}}" alt="" /></a></div>
                <div class="desc">
        ...
        <div style="display: none;" class="btn-group">
          ...
          <div class="dropdown-menu dropdown-menu-head pull-right">
            ...
            <ul class="dropdown-list gen-list">
              ...
              <li>
                <a href="#">
                <span class="thumb"><img src="{{url('/images/photos/user2.png')}}" alt="" /></span>
                <span class="desc">
              ...
              <li>
                <a href="#">
                <span class="thumb"><img src="{{url('/images/photos/user3.png')}}" alt="" /></span>
                <span class="desc">
              ...
              <li>
                <a href="#">
                <span class="thumb"><img src="{{url('/images/photos/user4.png')}}" alt="" /></span>
                <span class="desc">
              ...
              <li>
                <a href="#">
                <span class="thumb"><img src="{{url('/images/photos/user5.png')}}" alt="" /></span>
                <span class="desc">
